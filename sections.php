                ...
                <div class="col-12">
                    <div class="card card-success">
                        <div class="card-header">
                            ...
                            <div class="row mt-2">
                                <div class="">
                                    <a href="assets/Section Template.xlsx" download class="text-dark btn btn-default pl-3 pr-3 mr-0 mr-sm-2"><i class="fa fa-download"></i> Download Template</a>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="text" class="hidden" name="btn_action" id="btn_action1" value="section_upload_excel" />
...
<script>
    $(function () {
        ...
        $('#add_button').click(function(){
            $('#forms')[0].reset();
            $('.modal-title').html("<i class='fas fa-th'></i> <?php echo $title; ?>");
