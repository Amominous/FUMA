    ...
    $(function () {
        ...
        $(document).on('click', '.status', function(){
            ...
            if (title == 'Verify')
            {
                ...
                Swal.fire({
                    icon: 'question',
                    title: 'Are you sure to verify this report?',
            ...
            else
            {
                $('#forms')[0].reset();
                $('#id').val(id);
                $('#status').val('Not Verified');
                $('#addModal').modal('show');
                $('.modal-title').html("<i class='fas fa-times-circle'></i> Not Verify");
        ...
        $(document).on('submit','#forms', function(event){
            ...
            Swal.fire({
                icon: 'question',
                title: 'Are you sure to not verify this report?',
                showCancelButton: true,
                showDenyButton: false,
                confirmButtonText: '<i class="fa fa-check-circle"></i> Yes',
                cancelButtonText: `<i class="fa fa-times-circle"></i> No`,
        ...
        var dataTable = $("#datatables").DataTable({
            ...
            "order":[],
            "ajax":{
                url:"fetch/reports_filed.php?status=Pending",
                type:"POST"
            },
            "columnDefs":[
                {
