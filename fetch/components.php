...
$query .= "SELECT * FROM $COMPONENTS_TABLE WHERE ";
...
foreach($result as $row)
{
    ...
    $sub_array[] = '
        <div class="btn-group btn-group-md ">
            <a href="#" class="btn btn-success update " name="update" id="'.$row["id"].'" data-toggle="tooltip" data-placement="top" title="Update"><i class="fa fa-user-edit"></i> Update</a>
        </div>
    ';
...
$output = array(
	...
	"recordsFiltered" 	=> 	get_total_all_records($connect, $COMPONENTS_TABLE),
	"data"				=>	$data
);
